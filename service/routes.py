...
def read_account(account_id):
    """
    Reads an Account
    This endpoint will read an Account based the requested account_id
    """
...
def update_account(account_id):
    """
    Updates an Account
    This endpoint will update an Account based the requested account_id
    """
...
def delete_account(account_id):
    """
    Deletes an Account
    This endpoint will delete an Account based the requested account_id
    """
